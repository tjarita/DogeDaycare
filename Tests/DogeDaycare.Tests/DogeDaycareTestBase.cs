...
namespace DogeDaycare.Tests
{
    public abstract class DogeDaycareTestBase : AbpIntegratedTestBase
    {
        protected DogeDaycareTestBase()
        {
            //Seed initial data
        ...
        protected override void AddModules(ITypeList<AbpModule> modules)
        {
            ...
            modules.Add<DogeDaycareApplicationModule>();
            modules.Add<DogeDaycareDataModule>();
        }

        public void UsingDbContext(Action<DogeDaycareDbContext> action)
        {
            using (var context = LocalIocManager.Resolve<DogeDaycareDbContext>())
            {
        ...
        public T UsingDbContext<T>(Func<DogeDaycareDbContext, T> func)
        {
            T result;
